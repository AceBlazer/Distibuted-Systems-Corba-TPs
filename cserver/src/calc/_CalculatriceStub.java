...
public class _CalculatriceStub extends org.omg.CORBA.portable.ObjectImpl implements Calculatrice
{
  ...
  public float ajout (float x, float y)
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("ajout", true);
                $out.write_float (x);
                $out.write_float (y);
                $in = _invoke ($out);
  ...
  public float soustrait (float x, float y)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("soustrait", true);
                $out.write_float (x);
                $out.write_float (y);
                $in = _invoke ($out);
                float $result = $in.read_float ();
  ...
  public float divis (float x, float y) throws DivisionParZero
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("divis", true);
                $out.write_float (x);
                $out.write_float (y);
                $in = _invoke ($out);
                float $result = $in.read_float ();
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:DivisionParZero:1.0"))
                    throw DivisionParZeroHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                return divis (x, y        );
